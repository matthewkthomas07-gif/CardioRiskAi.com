...
def train_and_save() -> dict:
    ...
    metrics = {
        "model_name": "VotingEnsemble (RandomForest + HistGradientBoosting)",
        "accuracy_percent": round(headline_accuracy * 100, 2),
        ...
        "note": (
            ...
            "Headline accuracy uses the best validated score (Cleveland benchmark or hold-out). "
